    ...
    <>
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 flex items-center justify-between relative">
          {/* Logo */}
          <Link href="/" className="flex items-center gap-2 sm:gap-4 w-[calc(100%-44px)] sm:w-auto">
            <div className={cn(
            ...
            <div className="flex flex-col gap-1 min-w-0">
              <span className={cn(
                "[font-family:var(--font-cormorant)] font-bold text-lg sm:text-2xl transition-colors duration-300 truncate",
              ...
              <div className="flex flex-col gap-[5px]">
                ...
                <span className={cn(
                  "font-sans text-[7px] sm:text-[8px] font-bold tracking-[0.12em] sm:tracking-[0.2em] uppercase transition-colors duration-300",
          ...
          {!mobileOpen && (
            <button
              className="md:hidden absolute right-4 top-1/2 -translate-y-1/2 flex-shrink-0"
            ...
            <div className="flex items-center justify-between px-6 py-4 border-b border-gold/20">
              <Link href="/" onClick={() => setMobileOpen(false)} className="flex items-center gap-3">
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <span className="font-sans text-[7px] font-bold tracking-[0.15em] uppercase text-[#0A1628]">Legacy of Trust. Precision in Practice.</span>
                  <div className="h-px w-full bg-navy/30" />
                </div>
              </Link>
              <button onClick={() => setMobileOpen(false)} aria-label="Close menu" className="flex-shrink-0 ml-2 right-12">
